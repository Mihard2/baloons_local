...
$rehub_side_panel = array(
	...
	'template'    => array(
		...
		array(
			...
			'description' => esc_html__('Check this box to disable Featured Image, Video or Gallery in top part on post page', 'rehub-framework'),
			'default' => '0',
		),		
		array(
			'type' => 'toggle',
			'name' => 'disable_parts',
			'label' => esc_html__('Disable global parts?', 'rehub-framework'),
			'description' => esc_html__('Check this box to disable tags, breadcrumbs, author box, share buttons in post', 'rehub-framework'),
		), 		
