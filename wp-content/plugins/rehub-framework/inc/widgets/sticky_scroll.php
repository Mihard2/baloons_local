...
function widget( $args, $instance ) {
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => '', 'text_code' => '', 'type' => '', 'postid'=>'');		
		...
		<p>
			<label for="<?php echo ''.$this->get_field_id( 'type' ); ?>"><?php esc_html_e('Type post type where to show content. This option shows content only on inner (singular) pages. Possible values are: post, blog, product', 'rehub-framework'); ?></label>
