...
<?php wp_head(); ?>
<link rel="stylesheet" href='/wp-content/themes/rehub-theme/css/custom-style.css'/>
</head>
<body <?php body_class(); ?>>
                            ...
                            <div class="header-top clearfix rh-flex-center-align">    
                                ...
                                <div class="rh-flex-right-align top-social"> 
                                    ...
                                    <?php if (rehub_option('woo_cart_place') =='1') : ?>
                                        ...
                                        <?php if($woocommerce):?>
                                            <a class="cart-contents cart_count_<?php echo (int)$woocommerce->cart->cart_contents_count; ?>" href="<?php echo wc_get_cart_url(); ?>"><i class="rhicon rhi-cartfeather"></i> <?php esc_html_e( 'Cart', 'rehub-theme' ); ?> (<?php echo ''.$woocommerce->cart->cart_contents_count; ?>) - <?php echo ''.$woocommerce->cart->get_total(); ?></a>
                                         <?php endif; ?>
                                    <?php endif; ?>
                                </div>
                            </div>
