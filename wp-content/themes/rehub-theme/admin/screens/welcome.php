    ...
    <div class="feature-section">
		<div class="rehub-important-notice registration-form-container">
			...
			<?php else: ?>
				...
				<p>
					<span style="color:red"><?php esc_html_e( "If you wish to use this license for activating theme on another site, you must first release your license from this site by deactivating it below. Removing site does not release license, please deactivate license first before removing site", "rehub-theme" ); ?></span>
				</p>
