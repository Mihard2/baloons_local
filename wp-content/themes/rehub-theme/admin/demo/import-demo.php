...
function rehub_import_files() {
	...
	$demos = array(
		...
		array(
			...
			'categories' => array( esc_html__( 'E-commerce', 'rehub-theme' ) ),
			'import_file_url' => PLUGIN_REPO . 'demoimport/refashion-content.xml',
			'import_widget_file_url' => PLUGIN_REPO . 'demoimport/refashion-widgets.wie',				
		...
		array(
			...
			'categories' => array( esc_html__( 'Reviews', 'rehub-theme' ) ),				
			'rhfrontend' => PLUGIN_REPO . 'demoimport/reviewit-frontend.json',			
			'import_file_url' => PLUGIN_REPO . 'demoimport/reviewit-content.xml',
			'import_widget_file_url' => PLUGIN_REPO . 'demoimport/reviewit-widgets.wie',
