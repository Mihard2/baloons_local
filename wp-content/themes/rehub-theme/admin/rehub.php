	...
	class Rehub_Admin{
		...
		function rehub_admin_scripts() {
			...
			<?php if(rehub_option('rehub_headings_font')) : ?>
				.editor-post-title__block .editor-post-title__input, .editor-styles-wrapper h1.wp-block, .editor-styles-wrapper h2.wp-block, .editor-styles-wrapper h3.wp-block, .editor-styles-wrapper h4.wp-block, .editor-styles-wrapper h5.wp-block, .editor-styles-wrapper h6.wp-block, .wp-block-quote.is-style-large{
			...
			#post_rehub_offers .postbox-header{background:#007cba; border-bottom:none; color:#fff !important;}
			#post_rehub_offers .postbox-header .handle-order-higher, #post_rehub_offers .postbox-header .handle-order-lower, #post_rehub_offers .toggle-indicator{color:#fff !important;}
