        ...
        <!-- Title area -->
            <div class="title_single_area mb0 rh-flex-eq-height rh-flex-justify-btw flowhidden">
                ...
                <div class="post-head-image-part position-relative rh-336-sidebar mb0 rh-flex-center-align rh-flex-justify-center">
                    <?php echo WPSM_image_resizer::show_wp_image('full', '', array('css_class'=>'max-height-data', 'data-large_image_height'=>'200px', 'data-large_image_width'=>'', 'max_height'=> '200px')); ?>
                </div>
            </div>            
    </div>
</div>
...
<div class="rh-container"> 
    <div class="rh-content-wrap clearfix flowhidden rh-stickysidebar-wrapper">   
        <!-- Main Side -->
        <div class="rh-mini-sidebar-content-area single clearfix floatleft rh-sticky-container tabletblockdisplay">
            <div class="rh-post-wrapper">            
                <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
                    ...
                    <?php if(rehub_option('rehub_single_code')) : ?><div class="single_custom_bottom"><?php echo do_shortcode (rehub_option('rehub_single_code')); ?></div><div class="clearfix"></div><?php endif; ?>
        ...
        <!-- /Main Side -->  
        <!-- Sidebar -->
        <aside class="rh-mini-sidebar floatright rh-sticky-container hideontablet">            
