...
.dark_body .post-readopt .wpsm-versus-item{color: #fff;}
...
.dark_body .post-readopt .wpsm_pretty_list{color: #eee}
...
<?php 
	...
	ob_end_clean();
	echo '<link rel="preload" href="'.get_template_directory_uri().'/fonts/rhicons.woff2?leryx9" as="font" type="font/woff2" crossorigin="crossorigin">';
