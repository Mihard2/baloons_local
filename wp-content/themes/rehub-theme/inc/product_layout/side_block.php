                    ...
                    <?php if($image_url):?>
                        ...
                        <style scoped>
                            ...
                            #rh_woo_layout_inimage:before{content: " ";
                                background: url(<?php echo get_template_directory_uri() .'/images/subbg.webp';?>) no-repeat right bottom;
                                position: absolute;
                                bottom: 0;
                                right: 0;
                                left:0;
                    ...
                    <div class="rh-container position-static flowhidden pt15 pb30">                                   
                        ...
                        <div class="rh-360-sidebar tabletsblockdisplay summary whitebg rh-shadow3 rehub-sec-smooth calcposright float_p_trigger">
                            ...
                            <div class="re_wooinner_cta_wrapper padd20"> 
                                ...
                                <div class="mb15 mt15 pt15 border-top font90 hideonfloat"><?php woocommerce_template_single_meta();?></div>
                            </div> 
                        </div> 
                        <div class="rh-360-content-area tabletsblockdisplay woo_white_text_layout whitecolor">
                            <div class="mb20 font120 rh_opacity_5 fontbold"><?php woocommerce_template_single_excerpt();?></div>
                                        ...
                                        <?php if(!empty($prosvalues)):?>
                                            ...
                                            <div class="padd20 border-lightgrey woo_comment_text_pros mt15">
                                                ...
                                                <?php foreach ($prosvalues as $prosvalue) {
                                                    ...
                                                    echo '<span class="pros_comment_item blockstyle mb10">'.$prosvalue.'</span>';
                                                }?>
                                            </div>
                                        <?php endif;?>                                  
                                    </div>
