...
<div class="<?php if (rehub_option('rehub_sticky_nav') ==true){echo 'rh-stickme ';}?>header_five_style logo_section_wrap header_one_row">
    <div class="rh-container tabletblockdisplay mb0 disabletabletpadding">
        <div class="logo-section rh-flex-center-align tabletblockdisplay disabletabletpadding mb0">
            ...
            <!-- Main Navigation -->
            <div class="main-nav header_icons_menu mob-logo-enabled <?php if(rehub_option('header_five_menucenter')) : ?>rh-flex-grow1 rh-flex-center-align rh-flex-justify-center<?php else:?>rh-flex-right-align<?php endif;?> <?php echo ''.$header_menuline_style;?>">      
            ...
            <?php if(rehub_option('header_six_menu') != '') : ?>
                ...
                if (!empty ($nav_menu)) :?>
                    <div id="re_menu_near_logo" class="hideontablet flowvisible">
