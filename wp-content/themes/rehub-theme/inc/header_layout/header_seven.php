                    ...
                    <div class="tabledisplay">
                        ...
                        <?php if(rehub_option('header_seven_login') == true):?>
                            <div class="celldisplay login-btn-cell text-center">
                                ...
                                <?php echo wpsm_user_modal_shortcode(array('class' =>$classmenu, 'loginurl'=>$loginurl, 'icon'=> 'rhicon rhi-user'));?>
...
<!-- /Logo section -->  
<!-- Main Navigation -->
<div class="search-form-inheader header_icons_menu main-nav mob-logo-enabled<?php if (rehub_option('rehub_sticky_nav') ==true){echo ' rh-stickme';}?><?php echo ''.$header_menuline_style;?>">  
