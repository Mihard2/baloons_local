...
<?php $maximage = (!empty($maximage)) ? (int)$maximage : 80;?>
...
<div class="col_item item-small-news<?php if($image):?> item-small-news-image<?php endif;?><?php if($border):?> border-lightgrey pb10 pl10 pr10 pt10 mb20<?php endif;?>">
	...
	<?php if($image):?>
		<figure class="<?php if($border):?>img-centered-flex rh-flex-center-align rh-flex-justify-center<?php else:?>text-center<?php endif;?><?php if($center):?> mb20<?php endif;?>"><a href="<?php the_permalink();?>">
			<?php if($cropenable):?>
				<?php $width = $maximage * 1.3;?>
				<?php WPSM_image_resizer::show_static_resized_image(array('thumb'=> true, 'crop'=> true, 'height'=> $maximage, 'width'=> $width, 'no_thumb_url' => get_template_directory_uri() . '/images/default/noimage_100_70.png'));?>
			<?php else:?>
				<?php WPSM_image_resizer::show_static_resized_image(array('thumb'=> true, 'crop'=> false, 'height'=> $maximage, 'no_thumb_url' => get_template_directory_uri() . '/images/default/noimage_100_70.png'));?>
			<?php endif;?>
		</a>
		</figure>
	<?php endif;?>
